...
from ..utils.exceptions import MarkMissingError, TemplateError
from .detector import Detector
from .template import TemplateMatcher, _build_cells


_data_run_counter = 0
_dataset_lock     = threading.Lock()

_ann_color_ok = "#00C800"
_ann_color_ng = "#DD0000"
_tmpl_color_a = "#FFD700"
_tmpl_color_b = "#00E5FF"
